...
const SPEED_GAUGE_PX = 17;

const GAUGE_FASTEST_PATH =
...
const SPEED_GAUGE_PATHS: Record<SourceSpeedRank, string> = {
  1: GAUGE_SLOWEST_PATH,
  2: GAUGE_SLOW_PATH,
  3: GAUGE_FAST_PATH,
  4: GAUGE_FASTEST_PATH,
};
...
function nextTrackState(track: StatusTrack): string {
  return describeAhead(isAheadActivity(track.activity) ? track.activity : null, track.fraction ?? null, track.cached);
}
