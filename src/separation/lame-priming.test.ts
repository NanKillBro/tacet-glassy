// Vendored from composer src/audio/lame-priming.test.ts @ 30f0e2e

import { describe, expect, it } from "vitest";
import { findFirstMp3FrameOffset, parseLamePriming, stripLeading } from "@/separation/lame-priming";
